...
public class KnpskNoReps {
    ...
    private class FastScanner {
        ...
        FastScanner() throws FileNotFoundException {
            br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("src/knapsackWithoutReps/input.txt"))));
        }
    ...
    private void findMaxWeight(int W, int [] bars) {
        ...
        System.err.println(array[W][qty]);
    }
